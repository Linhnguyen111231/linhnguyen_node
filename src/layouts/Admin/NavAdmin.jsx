				...
				<div className="container-fluid">
					...
					<ul className="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li className="nav-item dropdown hidden-caret">
							<Link className="nav-link dropdown-toggle" href="#" id="messageDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							...
							<ul className="dropdown-menu messages-notif-box animated fadeIn" aria-labelledby="messageDropdown">
										...
										<div className="notif-center">
											<Link href="#">
												<div className="notif-img"> 
													<img src={require('../../assets/img/imgAdmin/jm_denis.jpg')} alt="Img Profile"/>
												</div>
											...
											<Link href="#">
												<div className="notif-img"> 
													<img src={require('../../assets/img/imgAdmin/chadengle.jpg')} alt="Img Profile"/>
												</div>
												<div className="notif-content">
											...
											<Link href="#">
												<div className="notif-img"> 
													<img src={require('../../assets/img/imgAdmin/mlane.jpg')} alt="Img Profile"/>
												</div>
												<div className="notif-content">
											...
											<Link href="#">
												<div className="notif-img"> 
													<img src={require('../../assets/img/imgAdmin/talha.jpg')} alt="Img Profile"/>
												</div>
												<div className="notif-content">
								...
								<li>
									<Link className="see-all" href="">See all messages<i className="fa fa-angle-right"></i> </Link>
								</li>
							</ul>
						</li>
						<li className="nav-item dropdown hidden-caret">
							...
							<ul className="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<div className="notif-scroll scrollbar-outer">
										<div className="notif-center">
											...
											<Link href="#">
												<div className="notif-img"> 
													<img src={require('../../assets/img/imgAdmin/profile2.jpg')} alt="Img Profile"/>
												</div>
												<div className="notif-content">
													<span className="block">
								...
								<li>
									<Link className="see-all" href="">See all notifications<i className="fa fa-angle-right"></i> </Link>
								</li>
							</ul>
						</li>
						<li className="nav-item dropdown hidden-caret">
								...
								<div className="dropdown-user-scroll scrollbar-outer">
									<li>
										<div className="user-box">
											<div className="avatar-lg"><img src={require('../../assets/img/imgAdmin/profile.jpg')} alt="image profile" className="avatar-img rounded"/></div>
