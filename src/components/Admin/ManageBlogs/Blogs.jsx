...
const Blogs =  () => {
    ...
    let dataView =''
      useEffect(()=>{
        if (keySearch !== '') {
            ...
            axios.post('api/admin/blogs-search',data)
            .then(res=>{
                if (res.data.status === 200) {
                    if (res.data.status!=='') {
                        console.log(res.data.data_search);
                    setDataBlogs(res.data.data_search)
                    }
                }
            })
        }else{
    ...
    const handleDelete = (e)=>{
        ...
        Swal.fire({
            title: `Do you want to delete Blog ${idAndName[1]}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                ...
                axios.post(`api/admin/delete-blogs/${idAndName[0]}`).then(res=>{
                    if (res.data.status === 200) {
